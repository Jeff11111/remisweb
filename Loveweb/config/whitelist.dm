...
var/global/list/ckeywhitelistweb = list("remis12", "jimmynutron2013", "GuppyLaxx", "Soulvapor", "SpicySalami")
...
var/global/list/villainlist = list("remis12", "jimmynutron2013", "GuppyLaxx", "Soulvapor", "SpicySalami")
