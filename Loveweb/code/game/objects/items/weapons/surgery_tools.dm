...
/obj/item/weapon/scissors/attack(mob/living/carbon/human/H as mob, mob/living/carbon/human/user, var/target_zone)
	...
	if(istype(H) && user.a_intent == "help" && (target_zone == "face" || target_zone == "head" || target_zone == "chest"))
		if((target_zone == "face" && H.f_style != "Shaved") || (H.h_style != "Bald" && target_zone == "head") || H.overlays_standing[4] != null) //4 = the bodyhair layer
